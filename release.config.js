  ...
  plugins: [
    ...
    [
      "@semantic-release/exec",
      {
        ...
        // deliberately fail-open: a Sentry processing timeout once took down
        // the whole 0.48.0 publish even though the upload itself had already
        // succeeded. A Sentry hiccup must never stop us shipping to npm — the
        // run log still carries the failure.
        prepareCmd:
