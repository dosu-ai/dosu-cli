...
export type CliDeploymentTargetRecord = Record<string, CliJson> & {
	paygated?: boolean
}

export type CliDraftMessageReviewItem = {
	body: string
	createdAt: string
	id: string
	kind: 'draft_message'
...
export type CliMessage = {
	...
	metadata: {
		agent?: {
			action?: string | null
			answered_questions?: Array<string> | null
			asked_questions?: Array<string> | null
			category?: string | null
			execution_time?: number | null
			failed_questions?: Array<string> | null
			...
			questions_by_generation_round?: Record<string, number> | null
...
export type CliPendingReviewItem = {
	createdAt: string
...
export type CliReviewDocument = {
	...
	publishedPage: CliReviewPage | null
	reviewPage: CliReviewPage
	shouldCommitToTriggerBranch: boolean
	suggestedTargetPath: string | null
	suggestedTargetProvider:
		| 'github'
		| 'gitlab'
		| 'notion'
		| 'confluence'
...
export declare const CLI_CONTRACT_HASH: 'ee6b987ca312'
...
export type DataSourceAttachToSpaceOutput = number
...
export type DataSourceCreateOutput = CliDataSource
...
export type DataSourceGetOutput = CliDataSource | null
...
export type DeploymentDataSourceCreateOutput = {
	created_at: string
	data_source_id: string
	deployment_id: string
} | null
...
export type KnowledgeStoreGetBySpaceIdOutput = {
	created_at: string
	id: string
	org_id: string
	space_id: string
...
export type LibrariesCreateOutput = {
	created_at: string
	created_by: string | null
...
export type LibrariesInfoOutput = {
	created_at: string
	created_by: string | null
	deleted_at: string | null
	description: string | null
...
export type LibrariesListOutput = Array<{
	created_at: string
	created_by: string | null
	deleted_at: string | null
	description: string | null
...
export type LibrariesUpdateOutput = {
	created_at: string
	created_by: string | null
	deleted_at: string | null
	description: string | null
...
export type MessagesGetMessageOutput = {
	action: 'create' | 'edit' | 'delete'
	author: string
	author_role: 'user' | 'assistant' | 'maintainer' | 'bot'
	body: string | null
...
export type MessagesListOutput = {
	channels: Array<CliSlackChannelRow>
	list: Array<{
		created_at: string | null
		group_id: string
		messages: Array<CliMessage>
		thread_id: string
	}>
	pageInfo: {
...
export type ReviewGetChangeOutput = {
	diff: string
	hasChanges: boolean
	id: string
	isNewDoc: boolean
	...
	source: string
	thread: CliChangeViewThread | null
	title: string
	version: number
}
...
export type ReviewGetThreadContextOutput =
	| {
			items: Array<CliDraftMessageReviewItem>
			type: 'messages'
	  }
	| {
			pageId: string
	...
	| {
			documents: Array<CliReviewDocument>
			type: 'document'
	  }
...
export type ReviewListPendingOutput = {
	items: Array<CliPendingReviewItem | CliDraftMessageReviewItem>
	total: number
	truncated: boolean
}
...
export type WorkspacesCreateOutput = CliDeployment | null
...
export type WorkspacesGetOutput = CliDeployment | null
